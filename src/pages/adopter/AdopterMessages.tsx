...
const AdopterMessages = () => {
  ...
  const sendMessageMutation = useMutation({
    mutationFn: (messageData: { recipient: string; content: { text: string }; adoption: string }) =>
      adopterMessagingService.sendMessageToFarmer({
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Communicate with your adopted farmers</p>
      </div>
            ...
            <div className="divide-y">
              {conversations.length === 0 ? (
                <div className="p-6 text-center text-gray-500">
                  ...
                  <p className="text-sm">Adopt a farmer to start messaging</p>
                </div>
              ) : (
                  ...
                  >
                    <div className="flex items-start space-x-3">
                      <Avatar className="h-10 w-10">
                        ...
                        <AvatarFallback>
                          {conversation.farmer.firstName[0]}
                          {conversation.farmer.lastName[0]}
                        </AvatarFallback>
                      </Avatar>
          ...
          {selectedConversation ? (
            <>
              ...
              <CardHeader className="pb-3">
                <div className="flex items-center space-x-4">
                  <Avatar className="h-12 w-12">
                    ...
                    <AvatarFallback>
                      {selectedConversation.farmer.firstName[0]}
                      {selectedConversation.farmer.lastName[0]}
                    </AvatarFallback>
                  </Avatar>
                  <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="text-center p-4 bg-green-50 rounded-lg">
                    ...
                    <p className="text-sm text-green-600">
                      You adopted {selectedConversation.farmer.firstName} on{' '}
                  ...
                  <div className="text-center p-8 text-gray-500">
                    <MessageCircle className="h-12 w-12 mx-auto mb-3 text-gray-300" />
                    <p>Your conversation with {selectedConversation.farmer.firstName} will appear here</p>
              ...
              <div className="p-4 border-t">
                <div className="flex space-x-2">
                  <Textarea
                    placeholder={`Send a message to ${selectedConversation.farmer.firstName}...`}
                    value={messageText}
            ...
            <CardContent className="flex-1 flex items-center justify-center">
              <div className="text-center text-gray-500">
                ...
                <p>Choose a farmer from the list to start messaging</p>
              </div>
            </CardContent>
          )}
        </Card>
...
export default AdopterMessages;
