              ...
              <div className="flex items-center text-sm text-muted-foreground">
                ...
                <span>
                  {(() => {
                    ...
                    if (typeof user.experience === 'number') return user.experience;
                    if (typeof user.experience === 'object' && user.experience.yearsOfExperience) {
                      return user.experience.yearsOfExperience;
                    }
                    return 0;
                  })()} years experience
                </span>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button
            ...
            disabled={bulkVerifyMutation.isPending || users.filter(u => u.verificationStatus === 'pending').length === 0}
          >
